      ...
      <div className='flex flex-col items-start gap-8 lg:flex-row'>
        ...
        <div className='flex-1 w-full mb-8 bg-white border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
            <input
              className='border border-gray-300 focus:border-green-600 rounded w-full px-4 h-14 text-sm outline-none'
              type='text'
              placeholder='Name*'
            />
            <input
            ...
            />
            <textarea
              className='border border-gray-300 focus:border-green-600 rounded w-full p-4 h-36 text-sm text-gray-400 outline-none resize-none'
              type='text'
              placeholder='Message*'
            ...
            <div className='flex gap-x-2'>
              <button
                className='bg-green-600 hover:bg-green-600 text-white rounded p-4 text-sm w-full transition'
                type='submit'
              >
                Send message
              </button>
              <button className='border border-green-600 text-green-600 hover:border-purple-600 hover:text-purple-600 rounded p-4 text-sm w-full transition'>
                Call
              </button>
            </div>
          </form>
